 ...
 * Write a function: class Solution { public int solution(int N); } that, given a positive integer N, returns the length
 ...
 */
public class BinaryGapSolutionTest extends TestCase {
    @Test
    public void testeNumeroValido() {
	BinaryGapSolution solution = new BinaryGapSolution();
	assertEquals(5, solution.binaryGapSolution(1041));
    }

    @Test
    public void testeValorZerado() {
	BinaryGapSolution solution = new BinaryGapSolution();
	assertEquals(0, solution.binaryGapSolution(0));
    }
}
